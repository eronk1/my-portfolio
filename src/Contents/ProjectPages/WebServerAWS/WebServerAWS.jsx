    ...
    <div>
      ...
      <LargeSection>
        ...
        <MediumSection>
          ...
          <SmallText>Due to a recent cyberattack, all non-essential ports were blocked on my school campus, causing my website to lose its essential function.</SmallText>
        ...
        <MediumSection>
          <MediumText>
            This is the fully configured website:
          </MediumText>
          <MediumText>
            <a target="_blank" href="https://chat.cags2.com">https://chat.cags2.com 
              <svg marginLeft="0.5rem" fill="var(--secondary-color)" width="1.5rem" height="1.5rem" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
